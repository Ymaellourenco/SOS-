  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center flex-1 text-center py-10 relative z-10 space-y-8">
        <div className="w-24 h-24 rounded-full bg-red-600/10 border-4 border-red-600 flex items-center justify-center animate-pulse shadow-[0_0_50px_rgba(220,38,38,0.3)]">
