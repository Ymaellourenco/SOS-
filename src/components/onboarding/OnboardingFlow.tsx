      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="pt-12 mb-10 text-center">
            <div className="inline-flex p-2 rounded-[28px] bg-slate-50 mb-6 overflow-hidden">
              <img src="/icons/icon-192.png" alt="SOS Mais" className="w-16 h-16 rounded-2xl object-cover" />
            </div>
