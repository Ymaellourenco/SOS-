          ...
          {activeSection === 'privacy' && (
            <div className="space-y-4 pb-2 relative z-0">
               ...
               <div className="space-y-2">
                 ...
                 <div className="bg-slate-50 p-5 rounded-[24px] border border-slate-200 space-y-1">
                   <p className="text-[10px] text-slate-800 font-bold uppercase leading-relaxed">
                     Ismael Lourenço, NIF 261595903, com morada na Rua Cândido dos Reis, Nº85 RC/ESQ, Viseu.
                   </p>
                   <p className="text-[9px] text-slate-600 leading-relaxed">Contacto para questões de privacidade: ismaellourenco227@gmail.com</p>
                 </div>
               </div>
          ...
          {activeSection === 'return' && (
            <div className="space-y-4 pb-2">
              ...
              <div className="space-y-4">
                ...
                <div className="p-5 bg-white rounded-[32px] border border-slate-100 shadow-sm space-y-2">
                  <p className="text-[11px] text-slate-900 font-black uppercase">Resolução Alternativa de Litígios (RAL)</p>
                  <p className="text-[10px] text-slate-500 leading-relaxed font-medium">Nos termos da Lei n.º 144/2015, em caso de litígio de consumo não resolvido diretamente connosco, o utilizador pode recorrer ao Centro Nacional de Informação e Arbitragem de Conflitos de Consumo (CNIACC), entidade de resolução alternativa de litígios de consumo que resolve litígios até 30.000€, sem custos associados. Morada: Rua D. Afonso Henriques, 1, 4700-030 Braga. Telefone: +351 253 619 107. E-mail: geral@cniacc.pt. Queixa online em <span className="font-black">www.cniacc.pt/pt/apresentacao-de-reclamacao</span>.</p>
                </div>
                <div className="p-5 bg-amber-50 rounded-[32px] border border-amber-200 space-y-2">
                  ...
                  <p className="text-[10px] text-amber-700 leading-relaxed">Nos termos do Decreto-Lei n.º 74/2017, o SOS MAIS disponibiliza aos utilizadores o Livro de Reclamações Eletrónico, acessível em <span className="font-black">www.livroreclamacoes.pt</span>. Este direito é exigível a partir do momento em que a entidade responsável esteja formalmente registada como prestador de bens/serviços a consumidores.</p>
                </div>
              </div>
            </div>
          )}
