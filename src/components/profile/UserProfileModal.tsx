              ...
              <div className="space-y-4">
                ...
                <div className="group">
                  ...
                  <div className="flex gap-2">
                    <div 
                      onClick={toggleVoice}
                      className="flex-1 bg-slate-50 border border-slate-100 rounded-xl px-3 py-2.5 flex items-center justify-between gap-2 cursor-pointer hover:bg-slate-100 transition-colors"
                      title="Navegação por Voz — Lê os botões e estados da app"
                    >
                      <div className="flex items-center gap-1.5 min-w-0">
                        <Volume2 className={cn("w-3.5 h-3.5 shrink-0", voiceEnabled ? "text-red-500" : "text-slate-300")} />
                        <span className="text-[9px] font-black uppercase text-slate-900 truncate">Navegação</span>
                      </div>
                      <div className={cn(
                    ...
                    >
                      <div className="flex items-center gap-1.5 min-w-0">
                        <Mic className={cn("w-3.5 h-3.5 shrink-0", voiceCommandsEnabled ? "text-red-500" : "text-slate-300")} />
                        <span className="text-[9px] font-black uppercase text-slate-900 truncate">Comandos</span>
                      </div>
                      <div className={cn(
                        "w-7 h-4 rounded-full transition-colors relative shrink-0",
                        ...
                        <motion.div 
                          animate={{ x: voiceCommandsEnabled ? 15 : 2 }}
                          className="absolute top-0.5 w-3 h-3 bg-white rounded-full shadow-sm"
                        />
                      </div>
                    </div>
