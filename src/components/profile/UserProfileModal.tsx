              ...
              <div className="space-y-4">
                ...
                <div className="group">
                  ...
                  <div className="flex gap-1.5">
                    <div 
                      onClick={toggleVoice}
                      className="flex-1 bg-slate-50 border border-slate-100 rounded-lg px-2 py-1 flex items-center justify-between gap-1 cursor-pointer hover:bg-slate-100 transition-colors"
                      title="Navegação por Voz — Lê os botões e estados da app"
                    >
                      <div className="flex items-center gap-1 min-w-0">
                        <Volume2 className={cn("w-2.5 h-2.5 shrink-0", voiceEnabled ? "text-red-500" : "text-slate-300")} />
                        <span className="text-[7px] font-black uppercase text-slate-900 truncate">Navegação</span>
                      </div>
                      <div className={cn(
                        ...
                        <motion.div 
                          animate={{ x: voiceEnabled ? 10 : 1 }}
                          className="absolute top-0.5 w-1.5 h-1.5 bg-white rounded-full shadow-sm"
                        />
                      </div>
                    </div>
                    ...
                    <div 
                      ...
                      className="flex-1 bg-slate-50 border border-slate-100 rounded-lg px-2 py-1 flex items-center justify-between gap-1 cursor-pointer hover:bg-slate-100 transition-colors"
                      title='Comandos de Voz — Diga "SOS" para ativar ajuda imediata'
                    >
                      <div className="flex items-center gap-1 min-w-0">
                        <Mic className={cn("w-2.5 h-2.5 shrink-0", voiceCommandsEnabled ? "text-red-500" : "text-slate-300")} />
                        <span className="text-[7px] font-black uppercase text-slate-900 truncate">Comandos</span>
                      </div>
                      <div className={cn(
                        "w-5 h-2.5 rounded-full transition-colors relative shrink-0",
                        ...
                        <motion.div 
                          animate={{ x: voiceCommandsEnabled ? 10 : 1 }}
                          className="absolute top-0.5 w-1.5 h-1.5 bg-white rounded-full shadow-sm"
                        />
                      </div>
                    </div>
