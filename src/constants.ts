...
export const OFFLINE_GUIDES: EmergencyGuide[] = [
  ...
  },
  {
    id: 'robbery',
    title: 'Assalto (Roubo)',
    description: 'Alguém a exigir dinheiro, telemóvel ou objetos.',
    category: 'heart',
    steps: [
  ...
  {
    id: 'pursuit',
    title: 'Perseguição / Ameaça de Agressão',
    description: 'Alguém a segui-lo(a) ou a tentar agredi-lo(a) fisicamente.',
    category: 'heart',
    steps: [
      'NÃO pare nem fique parado(a) — continue em movimento em direção a um local seguro.',
      'Dirija-se para um sítio com mais pessoas: uma loja aberta, um café, uma rua movimentada.',
      'Se conseguir, entre num estabelecimento e peça ajuda a quem lá estiver.',
      'Ligue 112 enquanto se desloca, se conseguir falar em segurança — ou use o botão de SOS da app para enviar a localização sem precisar de falar.',
      'Não entre em locais isolados, escadas vazias, ou becos, mesmo que pareçam um atalho.',
      'Se for apanhado(a), proteja a cabeça e o pescoço e grite por ajuda para chamar a atenção de outras pessoas.'
    ]
  },
  {
    id: 'aid',
