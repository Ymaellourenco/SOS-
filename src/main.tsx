...
console.log('%c[SOS MAIS] BUILD MARKER 2026-08-12-MAP-SEARCH-AND-PIN — se não vês ESTA versão exata, a app/browser não está a correr o código mais recente.', 'background:#dc2626;color:#fff;font-weight:bold;padding:4px 8px;border-radius:4px;');
