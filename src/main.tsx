...
console.log('%c[SOS MAIS] BUILD MARKER 2026-07-27-FIXED-MIXED-CONTENT — se não vês ESTA versão exata, a app/browser não está a correr o código mais recente.', 'background:#dc2626;color:#fff;font-weight:bold;padding:4px 8px;border-radius:4px;');
